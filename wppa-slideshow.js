...
function _wppaShowMetaData(mocc, key) {
	...
	if ( ! _wppaSlideShowRuns[mocc] ) {	
		if (key == 'show') {			// Show
			...
			// Display addthis
			// jQuery(".wppa-addthis-"+mocc).css('visibility', 'visible');
//			if (addthis) {
//				addthis.init();
//alert('init');
//			}
...
//        clean: true, 
//		add: { 
//			wppa_photo: _wppaPhotoIds[mocc][_wppaCurrentIndex[mocc]] //, 
//			my_name: "matt" 
//		} 
//	} 
//}
//alert(_wppaNames[mocc][_wppaCurrentIndex[mocc]]+' set, mocc='+mocc);
//}
		}
		else {							// Hide
