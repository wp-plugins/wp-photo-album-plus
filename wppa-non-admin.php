...
global $wppa_opt;
	...
	//	echo "\n".'<script type="text/javascript" src="'.WPPA_URL.'/lightbox/js/scriptaculous.js?load=effects,builder"></script>';
		...
		echo "\n".'<style type="text/css" media="screen">';
			echo "\n".'#lightbox{	position: absolute;	left: 0; width: 100%; z-index: 10010; text-align: center; line-height: 0;}';
			...
			echo "\n".'#overlay{ position: absolute; top: 0; left: 0; z-index: 10005; width: 100%; height: 500px; background-color: '.$obac.'; }';
		echo "\n".'</style>';
