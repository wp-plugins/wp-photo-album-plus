...
var wppaJsVersion='6.1.0';var wppaVersion='0';var wppaDebug=false;var wppaFullValign=[];var wppaFullHalign=[];var wppaFullFrameDelta=[];var wppaAnimationSpeed;var wppaImageDirectory;var wppaAutoColumnWidth=[];var wppaAutoColumnFrac=[];var wppaThumbnailAreaDelta;var wppaSlideShowTimeOut=2500;var wppaFadeInAfterFadeOut=false;var wppaTextFrameDelta=0;var wppaBoxDelta=0;var wppaPreambule;var wppaHideWhenEmpty=false;var wppaThumbnailPitch=[];var wppaFilmStripLength=[];var wppaFilmStripMargin=[];var wppaFilmStripAreaDelta=[];var wppaFilmShowGlue=false;var wppaIsMini=[];var wppaPortraitOnly=[];var wppaSlideShow;var wppaPhoto;var wppaOf;var wppaNextPhoto;var wppaPreviousPhoto;var wppaSlower;var wppaFaster;var wppaNextP;var wppaPrevP;var wppaAvgRating;var wppaMyRating;var wppaAvgRat;var wppaMyRat;var wppaDislikeMsg;var wppaShowDislikeCount=false;var wppaNoDislikes='no dislikes';var wppa1Dislike='1 dislike';var wppaDislikes='dislikes';var wppaIncludingMine='including mine';var wppaMiniTreshold=300;var wppaStart='Start';var wppaStop='Stop';var wppaPleaseName;var wppaPleaseEmail;var wppaPleaseComment;var wppaRatingOnce=true;var wppaBGcolorNumbar='transparent';var wppaBcolorNumbar='transparent';var wppaBGcolorNumbarActive='transparent';var wppaBcolorNumbarActive='transparent';var wppaFontFamilyNumbar='';var wppaFontSizeNumbar='';var wppaFontColorNumbar='';var wppaFontWeightNumbar='';var wppaFontFamilyNumbarActive='';var wppaFontSizeNumbarActive='';var wppaFontColorNumbarActive='';var wppaFontWeightNumbarActive='';var wppaNumbarMax='10';var wppaAjaxUrl='';var wppaLang='';var wppaNextOnCallback=false;var wppaRatingUseAjax=false;var wppaStarOpacity=0.2;var wppaSlideWrap=true;var wppaLightBox=[];var wppaEmailRequired=true;var wppaSlideBorderWidth=0;var wppaSlideInitRunning=[];var wppaAnimationType='fadeover';var wppaSlidePause=[];var wppaSlideBlank=[];var wppaRatingMax=5;var wppaRatingDisplayType='graphic';var wppaRatingPrec=2;var wppaFilmPageSize=[];var wppaAspectRatio=[];var wppaFullSize=[];var wppaStretch=false;var wppaThumbSpaceAuto=false;var wppaMinThumbSpace=4;var wppaMagnifierCursor='';var wppaArtMonkyLink='none';var wppaAutoOpenComments=false;var wppaUpdateAddressLine=false;var wppaFilmThumbTitle='';var wppaUploadUrl='';var wppaVoteForMe='';var wppaVotedForMe='';var wppaSlideSwipe=true;var wppaLightboxSingle=[];var wppaMaxCoverWidth=300;var wppaDownLoad='Download';var wppaSiteUrl='';var wppaWppaUrl='';var wppaIncludeUrl='';var wppaSlideToFullpopup=false;var wppaComAltSize=75;var wppaBumpViewCount=true;var wppaFotomoto=false;var wppaArtMonkeyButton=true;var wppaShortQargs=false;var wppaOvlHires=false;var wppaMasonryCols=[];var wppaVideoPlaying=[];var wppaAudioPlaying=[];var wppaSlideVideoStart=false;var wppaSlideAudioStart=false;var wppaAudioHeight=28;var _wppaId=[];var _wppaAvg=[];var _wppaDisc=[];var _wppaMyr=[];var _wppaVRU=[];var _wppaLinkUrl=[];var _wppaLinkTitle=[];var _wppaLinkTarget=[];var _wppaCommentHtml=[];var _wppaIptcHtml=[];var _wppaExifHtml=[];var _wppaToTheSame=false;var _wppaSlides=[];var _wppaNames=[];var _wppaFullNames=[];var _wppaDsc=[];var _wppaOgDsc=[];var _wppaCurIdx=[];var _wppaNxtIdx=[];var _wppaTimeOut=[];var _wppaSSRuns=[];var _wppaFg=[];var _wppaTP=[];var _wppaIsBusy=[];var _wppaFirst=[];var _wppaVIP=false;var _wppaTextDelay;var _wppaUrl=[];var _wppaLastVote=0;var _wppaSkipRated=[];var _wppaLbTitle=[];var _wppaStateCount=0;var _wppaDidGoto=[];var wppaTopMoc=0;var wppaColWidth=[];var _wppaShareUrl=[];var _wppaShareHtml=[];var _wppaFilmNoMove=[];var wppaShareHideWhenRunning=false;var _wppaHiresUrl=[];var wppaFotomotoHideWhenRunning=false;var wppaFotomotoMinWidth=400;var wppaPhotoView=[];var wppaCommentRequiredAfterVote=true;var _wppaIsVideo=[];var _wppaVideoHtml=[];var _wppaAudioHtml=[];var _wppaVideoNatWidth=[];var _wppaVideoNatHeight=[];var __wppaOverruleRun=false;jQuery(document).ready(function(){var anyAutocol=false;for(mocc=1;mocc<=wppaTopMoc;mocc++){if(wppaAutoColumnWidth[mocc]){wppaColWidth[mocc]=0;_wppaDoAutocol(mocc);anyAutocol=true;}}
...
wppaStopVideo(mocc);wppaStopAudio(mocc);if('auto'==mode){if(wppaSlidePause[mocc]){jQuery('#theimg'+fg+'-'+mocc).attr("title",wppaSlidePause[mocc]);setTimeout('_wppaNextSlide( '+mocc+', "auto" )',250);return;}}
...
_wppaDoAutocol(mocc);wppaStopAudio(mocc);if(wppaSlideAudioStart){var audio=document.getElementById('wppa-audio-'+_wppaId[mocc][_wppaCurIdx[mocc]]+'-'+mocc);if(audio){if(!wppaAudioPlaying[mocc]){audio.play();}}}}
...
function wppaMakeTheSlideHtml(mocc,bgfg,idx){var imgVideo=(_wppaIsVideo[mocc][idx]!='')?'video':'img';var theHtml;var url;var theTitle='title';if(wppaLightBox[mocc]=='wppa')theTitle='data-lbtitle';var mmEvents=wppaLightBox[mocc]==''?' onpause="wppaVideoPlaying['+mocc+'] = false;" onplay="wppaVideoPlaying['+mocc+'] = true;"':'';if(_wppaLinkUrl[mocc][idx]!=''){if(wppaSlideToFullpopup){theHtml='<a onclick="wppaStopAudio('+mocc+');'+_wppaLinkUrl[mocc][idx]+'" target="'+_wppaLinkTarget[mocc][idx]+'" title="'+_wppaLinkTitle[mocc][idx]+'">'+'<'+imgVideo+mmEvents+' title="'+_wppaLinkTitle[mocc][idx]+'" id="theimg'+bgfg+'-'+mocc+'" '+_wppaSlides[mocc][idx]+'</a>';}
else{theHtml='<a onclick="wppaStopAudio('+mocc+');" href="'+_wppaLinkUrl[mocc][idx]+'" target="'+_wppaLinkTarget[mocc][idx]+'" title="'+_wppaLinkTitle[mocc][idx]+'">'+'<'+imgVideo+mmEvents+' title="'+_wppaLinkTitle[mocc][idx]+'" id="theimg'+bgfg+'-'+mocc+'" '+_wppaSlides[mocc][idx]+'</a>';}}
...
html+='<a href="'+url+'"'+' onclick="wppaStopAudio('+mocc+');"'+' target="'+_wppaLinkTarget[mocc][idx]+'"'+' data-videonatwidth="'+_wppaVideoNatWidth[mocc][idx]+'"'+' data-videonatheight="'+_wppaVideoNatHeight[mocc][idx]+'"'+' data-videohtml="'+encodeURI(_wppaVideoHtml[mocc][idx])+'"'+' data-audiohtml="'+encodeURI(_wppaAudioHtml[mocc][idx])+'"'+' '+theTitle+'="'+_wppaLbTitle[mocc][idx]+'"'+' rel="'+wppaLightBox[mocc]+set+'">'+'<'+imgVideo+mmEvents+' title="'+_wppaLinkTitle[mocc][idx]+'" id="theimg'+bgfg+'-'+mocc+'" '+_wppaSlides[mocc][idx]+'</a>';if(wppaLightBox[mocc]=='wppa'){i=idx+1;while(i<_wppaUrl[mocc].length){if(wppaOvlHires&&_wppaIsVideo[mocc][i]==''){url=_wppaHiresUrl[mocc][i];}
else{url=wppaMakeFullsizeUrl(_wppaUrl[mocc][i]);}
html+='<a href="'+url+'"'+' data-videonatwidth="'+_wppaVideoNatWidth[mocc][i]+'"'+' data-videonatheight="'+_wppaVideoNatHeight[mocc][i]+'"'+' data-videohtml="'+encodeURI(_wppaVideoHtml[mocc][i])+'"'+' data-audiohtml="'+encodeURI(_wppaAudioHtml[mocc][i])+'"'+' '+theTitle+'="'+_wppaLbTitle[mocc][i]+'"'+' rel="'+wppaLightBox[mocc]+set+'"></a>';i++;}}
theHtml=html;}}
if(_wppaAudioHtml[mocc][idx]!=''){theHtml+='<audio'+' controls'+' id="wppa-audio-'+_wppaId[mocc][idx]+'-'+mocc+'"'+' class="wppa-audio-'+mocc+'"'+' onplay="wppaAudioPlaying['+mocc+'] = true;"'+' onpause="wppaAudioPlaying['+mocc+'] = false"'+' style="'+'position:relative;'+'top:-'+(wppaAudioHeight+wppaSlideBorderWidth)+'px;'+'z-index:10;'+'width:100%;'+'padding:0 '+wppaSlideBorderWidth+'px;'+'box-sizing:border-box;'+'"'+' >'+
...
else{html='<div id="wppa-ovl-full-bg" style="position:fixed; width:'+wppaWindowInnerWidth+'px; height:'+wppaWindowInnerHeight+'px; left:0px; top:0px; text-align:center;" >'+'<img id="wppa-overlay-img"'+' ontouchstart="wppaTouchStart( event, \'wppa-overlay-img\', -1 );"'+' ontouchend="wppaTouchEnd( event );"'+' ontouchmove="wppaTouchMove( event );"'+' ontouchcancel="wppaTouchCancel( event );"'+' src="'+wppaOvlUrl+'"'+' style="border:none; width:'+wppaWindowInnerWidth+'px; visibility:hidden; box-shadow:none; position:absolute;"'+' />';if(wppaHasAudio){html+='<audio'+' id="wppa-overlay-audio"'+' class="wppa-overlay-audio"'+' preload="metadata"'+
((wppaOvlAudioStart&&!wppaOvlAudioPlaying)?' autoplay':'')+' onpause="wppaOvlAudioPlaying = false;"'+' onplay="wppaOvlAudioPlaying = true;"'+' style="'+'width:100%;'+'position:absolute;'+'left:0px;'+'bottom:0px;'+'padding:0;'+'"'+' controls'+' >'+
wppaOvlAudioHtml+'</audio>';}
html+='<div style="height: 20px; width: 100%; position:absolute; top:0; left:0;" onmouseover="jQuery(\'#wppa-ovl-legenda-2\').css(\'visibility\',\'visible\');" onmouseout="jQuery(\'#wppa-ovl-legenda-2\').css(\'visibility\',\'hidden\');wppaShowLegenda=\'hidden\';" >'+'<div id="wppa-ovl-legenda-2" style="position:fixed; left:0; top:0; background-color:'+(wppaOvlTheme=='black'?'#272727':'#a7a7a7')+'; color:'+(wppaOvlTheme=='black'?'#a7a7a7':'#272727')+'; visibility:'+wppaShowLegenda+';" >'+'Mode='+wppaOvlMode+'. '+(wppaOvlIsSingle?wppaOvlFullLegendaSingle:wppaOvlFullLegenda)+'</div>'+'</div>';'</div>';}
if((!wppaIsVideo&&!wppaHasAudio)||wppaOvlFsPhotoId!=wppaPhotoId||wppaPhotoId==0){wppaStopVideo(0);wppaStopAudio(0);jQuery('#wppa-overlay-ic').html(html);}
...
else{html+='<img'+' id="wppa-overlay-img"'+' ontouchstart="wppaTouchStart( event, \'wppa-overlay-img\', -1 );"'+' ontouchend="wppaTouchEnd( event );"'+' ontouchmove="wppaTouchMove( event );"'+' ontouchcancel="wppaTouchCancel( event );"'+' src="'+wppaOvlUrl+'"'+' style="'+'border-width:16px;'+'border-style:solid;'+'border-color:'+wppaOvlTheme+';'+'margin-bottom:-15px;'+'max-width:'+mw+'px;'+'visibility:hidden;'+'box-shadow:none;"'+' />';if(wppaHasAudio){html+='<audio'+' id="wppa-overlay-audio"'+' class="wppa-overlay-audio"'+' preload="metadata"'+' onpause="wppaOvlAudioPlaying = false;"'+' onplay="wppaOvlAudioPlaying = true;"'+' style="'+'width:100%;'+'position:relative;'+'top:-'+(wppaAudioHeight+16)+'px;'+'padding:16px;'+'background-color:transparent;'+'box-sizing:border-box;'+'"'+' controls'+' >'+
wppaOvlAudioHtml+'</audio>';}
...
function wppaStopAudio(mocc){var items;if(mocc==0){items=jQuery('.wppa-overlay-audio');}
else{items=jQuery('.wppa-audio-'+mocc);}
if(items.length>0){var i=0;while(i<items.length){if(typeof(items[i].pause)=='function'){items[i].pause();}
i++;}}}
...
var next;if(wppaOvlIdx>=(wppaOvlUrls.length-1))next=0;else next=wppaOvlIdx+1;wppaOvlFsPhotoId=0;wppaPhotoId=0;wppaOvlShow(next);wppaConsoleLog('Setting timeout wppaOvlRun(), '+wppaOvlSlideSpeed);setTimeout('wppaOvlRun()',wppaOvlSlideSpeed);}
...
function wppaOvlHide(){wppaConsoleLog('wppaOvlHide');wppaStopAudio(0);jQuery('#wppa-overlay-ic').html('');jQuery('#wppa-overlay-ic').css({paddingTop:0});jQuery('#wppa-overlay-bg').fadeOut(300);jQuery(document).off('keydown',wppaOvlKeyboardHandler);wppaOvlFirst=true;wppaOvlRunning=false;wppaOvlMode='normal';jQuery('#wppa-overlay-sp').css({visibility:'hidden'});}
