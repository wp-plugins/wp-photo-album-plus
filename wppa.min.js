...
function wppaOvlShowPrev(){wppaConsoleLog('wppaOvlShowPrev');if(wppaOvlIsSingle)return false;if(wppaOvlIdx<1){wppaOvlHide();return false;}
wppaOvlShow(wppaOvlIdx-1);return false;}
function wppaOvlShowNext(){wppaConsoleLog('wppaOvlShowNext');if(wppaOvlIsSingle)return false;if(wppaOvlIdx>=(wppaOvlUrls.length-1)){wppaOvlHide();return false;}
wppaOvlShow(wppaOvlIdx+1);return false;}
