...
html+='<a href="'+url+'"'+' data-videonatwidth="'+_wppaVideoNatWidth[mocc][i]+'"'+' data-videonatheight="'+_wppaVideoNatHeight[mocc][i]+'"'+' data-videohtml="'+encodeURI(_wppaVideoHtml[mocc][i])+'"'+' data-audiohtml="'+encodeURI(_wppaAudioHtml[mocc][i])+'"'+' '+theTitle+'="'+_wppaLbTitle[mocc][i]+'"'+' rel="'+wppaLightBox[mocc]+set+'"></a>';i++;}}
theHtml=html;}}
if(_wppaAudioHtml[mocc][idx]!=''){theHtml+='<audio'+' controls'+' id="wppa-audio-'+_wppaId[mocc][idx]+'-'+mocc+'"'+' class="wppa-audio-'+mocc+' wppa-audio-'+_wppaId[mocc][idx]+'-'+mocc+'"'+' onplay="wppaAudioPlaying['+mocc+'] = true;"'+' onpause="wppaAudioPlaying['+mocc+'] = false"'+' style="'+'position:relative;'+'top:-'+(wppaAudioHeight+wppaSlideBorderWidth)+'px;'+'z-index:10;'+'width:'+_wppaVideoNatWidth[mocc][idx]+'px;'+'left:'+(wppaMax(0,(wppaGetContainerWidth(mocc)-_wppaVideoNatWidth[mocc][idx])/2))+'px;'+'padding:0 '+wppaSlideBorderWidth+'px;'+'box-sizing:border-box;'+'"'+' >'+
_wppaAudioHtml[mocc][idx]+'</audio>';}
jQuery("#theslide"+bgfg+"-"+mocc).html(theHtml);}
function wppaMax(i,j){if(i>j)return i;return j;}
