...
function wppaEditPhoto(mocc,id){var name='Edit Photo '+id;var desc='';var width=960;var height=512;if(screen.availWidth<width)width=screen.availWidth;var wnd=window.open("","_blank","toolbar=no, location=no, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=yes, copyhistory=yes, width="+width+", height="+height,true);wnd.document.write('<!DOCTYPE html>');wnd.document.write('<html>');wnd.document.write('<head>');wnd.document.write('<link rel="stylesheet" id="wppa_style-css"  href="'+wppaSiteUrl+'/wp-content/plugins/wp-photo-album-plus/wppa-admin-styles.css?ver='+wppaVersion+'" type="text/css" media="all" />');wnd.document.write('<style>body {font-family: sans-serif; font-size: 12px; line-height: 1.4em;}a {color: #21759B;}</style>');wnd.document.write('<script type="text/javascript" src="'+wppaSiteUrl+'/wp-includes/js/jquery/jquery.js?ver='+wppaVersion+'"></script>');wnd.document.write('<script type="text/javascript" src="'+wppaSiteUrl+'/wp-includes/js/jquery/jquery-migrate.min.js?ver='+wppaVersion+'"></script>');wnd.document.write('<script type="text/javascript" src="'+wppaSiteUrl+'/wp-content/plugins/wp-photo-album-plus/wppa-admin-scripts.js?ver='+wppaVersion+'"></script>');wnd.document.write('<title>'+name+'</title>');wnd.document.write('<script type="text/javascript">wppaAjaxUrl="'+wppaAjaxUrl+'";</script>');wnd.document.write('</head>');wnd.document.write('<body>');var xmlhttp=wppaGetXmlHttp();var data='action=wppa&wppa-action=front-edit&photo-id='+id+'&moccur='+mocc;var url=wppaAjaxUrl+'?'+data;xmlhttp.open('GET',url,false);xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");xmlhttp.send(data);if(xmlhttp.readyState==4&&xmlhttp.status==200){var result=xmlhttp.responseText;wnd.document.write(result);}
wnd.document.write('</body>');wnd.document.write('</html>');}
...
function wppaAjaxComment(mocc,id){jQuery("#wppa-comment-spin-"+mocc).css('display','inline');var xmlhttp=wppaGetXmlHttp();var data='action=wppa&wppa-action=do-comment&photo-id='+id
