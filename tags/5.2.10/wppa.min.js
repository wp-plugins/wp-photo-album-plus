...
function wppaMakeNameHtml(mocc){var result;switch(wppaArtMonkyLink){case'file':case'zip':if(wppaArtMonkeyButton){result='<input type="button" title="Download" style="cursor:pointer; margin-bottom:0px;" class="wppa-download-button" onclick="wppaAjaxMakeOrigName('+mocc+', '+_wppaId[mocc][_wppaCurIdx[mocc]]+');" value="'+wppaDownLoad+': '+_wppaFullNames[mocc][_wppaCurIdx[mocc]]+'" />';}
...
var wppaFotomotoToolbarIds=new Array();function wppaFotomotoToolbar(mocc,url){if(wppaColWidth[mocc]>=500){jQuery('#wppa-fotomoto-container-'+mocc).css('display','inline');jQuery('#wppa-fotomoto-checkout-'+mocc).css('display','inline');}
