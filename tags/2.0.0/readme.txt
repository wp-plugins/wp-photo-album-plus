...
* You can now use fading effects in the slideshow.
...
* Althoug I tested it and could not reproduce it, some users report that the theme Twenty Ten 1.0 (by the Wordpress team) should screws up the form security in this plugin in a way that nobody is allowed to save any changes.
