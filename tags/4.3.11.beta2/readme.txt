...
* You can now select an animation type other than fading in Table IV-4.
* Swipe left/right should work now on mobile devices (next/previous photo in slideshow display).

= Other changes =

* The embedded lightbox will now lay on top of the branding image of theme Twenty eleven.
